            ...
            <div className="ml-auto flex items-center gap-2">
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button variant="ghost" className="hidden sm:flex items-center gap-2 pl-2 border-l border-border h-10 px-2 hover:bg-muted/50 transition-colors cursor-pointer rounded-none rounded-r-md">
                    ...
                    <div className="leading-none text-left flex flex-col items-start pt-0.5">
                      <div className="text-sm font-medium">{user.name || "Researcher"}</div>
                      <Badge variant="secondary" className="mt-0 text-[10px] capitalize px-1.5 py-0 leading-tight">Researcher</Badge>
                    </div>
                ...
                <DropdownMenuContent align="end" className="w-56 mt-1">
                  ...
                  <DropdownMenuSeparator />
                  <DropdownMenuItem className="cursor-pointer" onClick={() => navigate("/researcher/profile")}>
                    <User className="mr-2 h-4 w-4" />
                    <span>Profile</span>
                  </DropdownMenuItem>
                  <DropdownMenuItem className="cursor-pointer" onClick={() => navigate("/researcher/settings")}>
